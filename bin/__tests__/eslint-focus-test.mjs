...
test("usage", () => {
	expect(runSync(["--help"])).toMatchInlineSnapshot(`
		...
		Examples:
		  ...
		  npx eslint-focus react-hooks/exhaustive-deps . --fix                                                    Fixes all \`react-hooks/exhaustive-deps\` issues inside the current directory.
